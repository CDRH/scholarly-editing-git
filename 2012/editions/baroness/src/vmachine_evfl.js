...
function resizePanels() {
   ...
   var minPanelWidth = 375 - borderWidth;
...
function showPanel(e, theInstance, x, y) {
   ...
   function showImgPanel(e, theInstance, theImgSrc, theWitness, x, y) {
     ...
     var theImg = "<img title='Page image' alt='Page image' data-zoomsrc='"+ theImgSrc + "' src='"+ theImgSrc + "'>";
...
var popbackground="#6699CC" //specify backcolor or background image for pop window
...
jkpopwin.document.write('<html><title>'+windowtitle+'</title><body '+bodyattribute+'><img width="100%" height="100%" src="'+imgpath+'" style="margin-bottom: 0.5em"><br />'+textdescription+'</body></html>')
