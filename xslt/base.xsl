                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <div class="edition">
                                ...
                                <xsl:if test="descendant::tei:sourceDesc//tei:listWit"><xsl:choose><xsl:when test="descendant::tei:idno[@type='edition']='swayzedrama'"></xsl:when><xsl:otherwise><xsl:apply-templates select="//tei:sourceDesc//tei:listWit"/><xsl:call-template name="witnessName"/></xsl:otherwise></xsl:choose></xsl:if>
                                <xsl:apply-templates/>
                            </div>
                        </xsl:otherwise>
                    </xsl:choose>
...
<xsl:choose>
    ...
    <xsl:template match="tei:p">
        ...
        <xsl:choose>
            ...
            <xsl:when
                test="//tei:idno[@type='edition'] = 'cranchjournal'">
                <xsl:choose>
            ...
            <xsl:when
                test="//tei:idno[@type='edition'] = 'markonthewall'">
                <xsl:choose>
            ...
            <xsl:when
                test="//tei:idno[@type='edition'] = 'lowelledition'">
                <xsl:choose>
            ...
            <xsl:when
                test="//tei:idno[@type='edition'] = 'stufaiuolo'">
                <xsl:choose>
                    <xsl:when test="//tei:idno[@type='file'] = 'intro.lowelledition'">
                        <div class="p">
                            <xsl:apply-templates />
            ...
            <xsl:when
                test="//tei:idno[@type='edition'] = 'swayzedrama'">
                <xsl:choose>
            ...
            <xsl:when
                test="//tei:idno[@type='edition'] = 'avisos'">
                <xsl:variable name="pNumber"><xsl:for-each select="."><xsl:value-of select="substring(@n,2)"/></xsl:for-each></xsl:variable>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                    <div class="paragraphNav"><span class="paragraphNumber"><xsl:value-of select="$pNumber"/></span>
                            <xsl:choose>
                                <xsl:when test="$avisos_english='yes'">
                                    <a title="see paragraph in the original Spanish"><xsl:attribute name="href">avisos.html#s<xsl:value-of
                                        select="$pNumber" /></xsl:attribute><xsl:attribute name="class"
                                            >OrigSpanishPara</xsl:attribute><!--&#9776;-->orig &#182;<xsl:value-of select="$pNumber"/></a>
                                    <a title="see paragraph in modernized Spanish"><xsl:attribute name="href">avisos_modernized.html#s<xsl:value-of
                                        select="$pNumber" /></xsl:attribute><xsl:attribute name="class"
                                            >ModSpanishPara</xsl:attribute>mod &#182;<xsl:value-of select="$pNumber"/></a>
                                </xsl:when>
                                <xsl:when test="$avisos_modernized='yes'">
                                    <a title="see paragraph in the original Spanish"><xsl:attribute name="href">avisos.html#s<xsl:value-of
                                        select="$pNumber" /></xsl:attribute><xsl:attribute name="class"
                                            >OrigSpanishPara</xsl:attribute>orig &#182;<xsl:value-of select="$pNumber"/></a>
                                    <a title="see paragraph in English translation"><xsl:attribute name="href">avisos_english.html#e<xsl:value-of
                                        select="$pNumber" /></xsl:attribute><xsl:attribute name="class"
                                            >EnglishPara</xsl:attribute>Engl &#182;<xsl:value-of select="$pNumber"/></a>
                                </xsl:when>
                                <xsl:otherwise>
                                    <a title="see paragraph in modernized Spanish"><xsl:attribute name="href">avisos_modernized.html#s<xsl:value-of
                                        select="$pNumber" /></xsl:attribute><xsl:attribute name="class"
                        ...
                        <div class="p"><a><xsl:attribute name="name" select="@n"/></a>
                            <xsl:apply-templates/>
                        </div>
                    </xsl:otherwise>
                </xsl:choose>
            ...
            <xsl:when
                test="//tei:idno[@type='edition'] = 'youngidea'">
                <xsl:choose>
    ...
    <!-- linebreak rendering -->
    <xsl:template match="tei:lb"><xsl:choose><xsl:when test="$avisos_modernized='yes'"></xsl:when><xsl:when test="attribute::break='no'"></xsl:when><xsl:otherwise>
        <br/></xsl:otherwise></xsl:choose>
    </xsl:template>
<!-- basic <emph> rendering -->
<xsl:template match="//tei:emph"><xsl:choose>
    <xsl:when test="@rend='smallcaps' or @rend='small caps'"><span class="smallcaps"><xsl:apply-templates/></span></xsl:when>
    ...
    <xsl:variable name="rendvalue"><xsl:value-of select="@rend"/></xsl:variable>
        <xsl:choose>
            ...
            <xsl:when test="./attribute::rend='underline align(center)'"><u><xsl:apply-templates/></u></xsl:when>
            <xsl:when test="./attribute::rend='underline align(right)'"><span class="align_right"><u><xsl:apply-templates/></u></span></xsl:when>
            <xsl:when test="./attribute::rend='align(right)'"><span class="align_right"><xsl:apply-templates/></span></xsl:when>
            <xsl:when test="./attribute::rend='align(center)'"><span class="center"><xsl:apply-templates/></span></xsl:when>
            <xsl:when test="./attribute::rend='double-underline' or ./attribute::rend='2-underline'">
        ...
        <xsl:choose>
                        ...
                        <xsl:attribute name="href">
                            <xsl:choose>
                                ...
                                <xsl:when test="$editionName='stufaiuolo'">
                                    <xsl:for-each select="child::tei:graphic"><xsl:text>stufaiuolo/pages/viewsize/</xsl:text>
                                    <xsl:value-of select="substring(./attribute::url,7)" /></xsl:for-each>
                                </xsl:when>
            ...
            <xsl:otherwise>
                <span>
                    ...
                    <xsl:if test="$fileName='cranchjournal'"><h3><xsl:apply-templates select="child::tei:head"/></h3></xsl:if>
                    <xsl:if test="$fileName='intro.hejinian'"><xsl:for-each select="child::teiE:egXML">
                        ...
                        <xsl:attribute name="src">
                            <xsl:choose>
                                ...
                                <xsl:when test="$editionName='markonthewall'"
                                    >markonthewall/<xsl:value-of
                                        select="./attribute::url" /> </xsl:when>
                                <xsl:when test="$editionName='cranchjournal'"
                                    >cranchjournal/<xsl:value-of
                                        select="./attribute::url" /> </xsl:when><xsl:when test="$editionName='hejinian'"
                                            >hejinian/<xsl:value-of
                                                select="./attribute::url" /> </xsl:when>
                                <xsl:when test="$editionName='swayzedrama'"
                                    >swayzedrama/<xsl:value-of
                                        select="./attribute::url" /> </xsl:when>
                                <xsl:when test="$editionName='stufaiuolo'"
                                    >stufaiuolo/<xsl:value-of
                                        select="./attribute::url" /> </xsl:when>
                    ...
                    <span class="fig_caption">
                        <xsl:for-each select="descendant::tei:head">
                            <xsl:choose><xsl:when test="$fileName='cranchjournal'"></xsl:when><xsl:otherwise><h3>
                                <xsl:apply-templates />
...
<xsl:for-each select="child::tei:head"><h2><xsl:apply-templates/></h2></xsl:for-each>
    ...
    <xsl:template match="//tei:l">
        <xsl:choose><xsl:when test="parent::tei:quote/ancestor::tei:note/ancestor::tei:back/ancestor::tei:TEI/descendant::tei:idno[@type='edition']='cranchjournal'"><xsl:apply-templates/><xsl:if test="following-sibling::tei:l">/&#160;</xsl:if></xsl:when><xsl:otherwise><span><xsl:attribute name="class">poem_line<xsl:if test="@rend"><xsl:choose><xsl:when test="@rend='align(center)'">_center</xsl:when><xsl:otherwise>_<xsl:value-of select="@rend"/></xsl:otherwise></xsl:choose></xsl:if></xsl:attribute>
            <xsl:apply-templates/>
...
<xsl:when test="$editionName='stufaiuolo'"><xsl:choose>
                    <xsl:when test="@type='v_msDesc'">
                        ...
                        <div class="appEntry">
                            <a href="#" class="closenote">X</a>
                            <div class="appRdg">
                                <xsl:for-each select="doc('../2015/editions/stufaiuolo/stufaiuolo.valentiniana.xml')//tei:msDesc"><h1>Manuscript Description, Valentiniana MS</h1>
    ...
    <xsl:when test="@type='r_msDesc'">
        ...
        <div class="appEntry">
            <a href="#" class="closenote">X</a>
            <div class="appRdg">
                <xsl:for-each select="doc('../2015/editions/stufaiuolo/stufaiuolo.riccardiana.xml')//tei:msDesc"><h1>Manuscript Description, Riccardiana MS</h1>
                    <p><xsl:for-each select="//tei:msIdentifier/*">
                        <xsl:apply-templates/><xsl:if test="following-sibling::*"><xsl:text>, </xsl:text></xsl:if>
                    </xsl:for-each></p>
                    <xsl:variable name="mspart">
            ...
            <xsl:otherwise>
                ...
                <a>
                    <xsl:attribute name="href">
                        ...
                        <xsl:if test="@type!='url'"><xsl:choose><xsl:when test="@type='email'"/><xsl:otherwise><xsl:value-of select="$siteroot"/></xsl:otherwise></xsl:choose></xsl:if><xsl:value-of select="@target"/>
                        <xsl:choose>
                            <xsl:when test="$editionName='cwnewspaperpoetry'"><xsl:choose><xsl:when test="contains(@target, 'pp')">.jpg</xsl:when><xsl:when test="@type='url'"></xsl:when><xsl:otherwise>.html</xsl:otherwise></xsl:choose></xsl:when>
                            <xsl:when test="@type='url'"/>
                            <xsl:when test="@type='html'">.html</xsl:when>
                            <xsl:when test="@type='pdf'">.pdf</xsl:when>
                            <xsl:when test="@type='xml'">.xml</xsl:when>
    ...
    <xsl:template match="//tei:sourceDesc//tei:listWit">
        <ul class="listWit">
            ...
            <xsl:for-each select="./child::tei:witness">
                <li><a><xsl:attribute name="href"><xsl:value-of select="$siteroot"/><xsl:choose><xsl:when test="ancestor::tei:TEI//tei:idno[@type='edition'] = 'sunsetwings'">2013</xsl:when><xsl:when test="ancestor::tei:TEI//tei:idno[@type='edition'] = 'markonthewall'">2014</xsl:when><xsl:when test="ancestor::tei:TEI//tei:idno[@type='edition'] = 'lowelledition'">2015</xsl:when></xsl:choose>/editions/<xsl:value-of select="//tei:idno[@type='edition']"/>_<xsl:value-of select="@xml:id"/>.html</xsl:attribute><xsl:if test="ancestor::tei:TEI//tei:idno[@type='edition'] = 'sunsetwings'"><xsl:value-of select="@xml:id"/>.&#160;</xsl:if><xsl:apply-templates/></a></li>
            </xsl:for-each>
           </ul></div></li> 
        </ul>
