...
<xsl:otherwise><ul>
    ...
    <xsl:template name="volCitation">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$idno='essay.grayprice' or $idno='essay.v37intro' or $idno='essay.mcgann' or $idno='essay.2016presidentialaddress' or $idno='essay.alpertabrams' or $idno='essay.davies' or $idno='essay.schulze'"><h5>2016, Volume 37</h5></xsl:when>
